...
{{-- hero de recherche  --}}
    ...
    <div class="hero-section px-10 py-3 bg-slate-50">
        ...
        <div>
            ...
            <div class="grid grid-cols-4 py-5 gap-5">
                ...
                <div class="text-slate-800  shadow-xs border border-slate-300 relative bg-white rounded p-1">
                    
                    <div class="group relative">
                        
                        <img class="h-auto w-full object-cover rounded" src="{{ asset('images/product-2.jpg') }}" alt="">
                        ...
                        <div class="opacity-0 flex flex-col gap-2 absolute inset-0 transition duration-300 group-hover:opacity-100 bg-gray/10 backdrop-blur-sm items-center justify-center">
                            ...
                            <button class="bg-slate-800 text-[11px] text-white p-2 rounded cursor-pointer">Ajouter au Panier</button>
                            
                        </div>
                        
                        <div class="flex flex-col gap-1 text-end px-6">
                            <p class="font-semibold" >Fraise</p>
                            <div class="flex  items-center justify-between" >
                                <h2 class="font-semibold text-red-500 line-through">4.400.000 Ar</h2>
                                <h2 class="font-bold text-xl">2.400.000 Ar</h2>
                            </div>
                        </div>
                    ...
                    <button class="absolute top-0 p-1 bg-red-100 left-0 text-[10px] font-bold text-red-600" >40 disponible(s)</button>
    ...
    <div class="py-3 px-10">
        ...
        <div class="grid grid-cols-4 py-5 gap-5 z-0">
            ...
            <div class="text-slate-800 relative shadow-xs border border-slate-300 bg-white rounded p-1">

                <div class="group relative">

                    <img class="h-auto w-full object-cover rounded" src="{{ asset('images/product-1.jpg') }}" alt="">
                    ...
                    <div class="flex flex-col gap-1 text-end px-6">
                        <p class="font-semibold" >Poivron</p>
                        <h2 class="font-bold text-xl">2.400.000 Ar</h2>
                    </div>
